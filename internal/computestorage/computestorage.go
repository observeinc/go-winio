...
import (
	...
	"github.com/observeinc/go-winio/internal/interop"
)

//go:generate go run github.com/observeinc/go-winio/tools/mkwinsyscall -output zsyscall_windows.go computestorage.go
